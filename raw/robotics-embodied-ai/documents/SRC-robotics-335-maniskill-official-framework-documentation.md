---
source_id: "SRC-robotics-335"
title: "ManiSkill official framework documentation"
source_type: "product_documentation"
publisher: "ManiSkill / SAPIEN"
...
aliases:
  - SRC-robotics-335
---
# ManiSkill official framework documentation

## ManiSkill

![teaser](https://maniskill.readthedocs.io/en/latest/_images/teaser.jpg)

Sample of environments/robots rendered with ray-tracing. Scene datasets sourced from AI2THOR and ReplicaCAD

[![Downloads](https://static.pepy.tech/badge/mani_skill)](https://pepy.tech/project/mani_skill) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mani-skill/ManiSkill/blob/main/examples/tutorials/1_quickstart.ipynb) [![PyPI version](https://badge.fury.io/py/mani-skill.svg)](https://badge.fury.io/py/mani-skill) [![Docs status](https://img.shields.io/badge/docs-passing-brightgreen.svg)](https://maniskill.readthedocs.io/en/latest/) [![Discord](https://img.shields.io/discord/996566046414753822?logo=discord)](https://discord.gg/x8yUZe5AdN)
