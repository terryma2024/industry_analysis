---
source_id: "SRC-robotics-067"
title: "Universal Manipulation Interface GitHub repository"
source_type: "open_source_repository"
publisher: "real-stanford"
source_date: "2024"
...
aliases:
  - SRC-robotics-067
---
# Universal Manipulation Interface GitHub repository

## Universal Manipulation Interface

[\[Project page\]](https://umi-gripper.github.io/) [\[Paper\]](https://umi-gripper.github.io/#paper) [\[Hardware Guide\]](https://docs.google.com/document/d/1TPYwV9sNVPAi0ZlAupDMkXZ4CA1hsZx7YDMSmcEy6EU/edit?usp=sharing) [\[Data Collection Instruction\]](https://swanky-sphere-ad1.notion.site/UMI-Data-Collection-Tutorial-4db1a1f0f2aa4a2e84d9742720428b4c?pvs=4) [\[SLAM repo\]](https://github.com/cheng-chi/ORB_SLAM3) [\[SLAM docker\]](https://hub.docker.com/r/chicheng/orb_slam3)

[![](https://github.com/real-stanford/universal_manipulation_interface/raw/main/assets/umi_teaser.png)](https://github.com/real-stanford/universal_manipulation_interface/blob/main/assets/umi_teaser.png)

[Cheng Chi](http://cheng-chi.github.io/) <sup>1,2</sup>, [Zhenjia Xu](https://www.zhenjiaxu.com/) <sup>1,2</sup>, [Chuer Pan](https://chuerpan.com/) <sup>1</sup>, [Eric Cousineau](https://www.eacousineau.com/) <sup>3</sup>, [Benjamin Burchfiel](http://www.benburchfiel.com/) <sup>3</sup>, [Siyuan Feng](https://www.cs.cmu.edu/~sfeng/) <sup>3</sup>,

[Russ Tedrake](https://groups.csail.mit.edu/locomotion/russt.html) <sup>3</sup>, [Shuran Song](https://www.cs.columbia.edu/~shurans/) <sup>1,2</sup>

<sup>1</sup> Stanford University, <sup>2</sup> Columbia University, <sup>3</sup> Toyota Research Institute
...
Despite our significant effort on robustness improvement, OBR\_SLAM3 is still the most fragile part of UMI pipeline. If you are an expert in SLAM, please consider contributing to our fork of [OBR\_SLAM3](https://github.com/cheng-chi/ORB_SLAM3) which is specifically optimized for UMI workflow.
...
2. Setup UR5 with teach pendant:
	- Obtain IP address and update [eval\_robots\_config.yaml](https://github.com/real-stanford/universal_manipulation_interface/blob/main/example/eval_robots_config.yaml) /robots/robot\_ip.
	...
	If you are using Franka, follow this [instruction](https://github.com/real-stanford/universal_manipulation_interface/blob/main/franka_instruction.md).
3. Setup WSG50 gripper with web interface:
	- Obtain IP address and update [eval\_robots\_config.yaml](https://github.com/real-stanford/universal_manipulation_interface/blob/main/example/eval_robots_config.yaml) /grippers/gripper\_ip.
		- In Settings > Command Interface
		- Disable "Use text based Interface"
				- Enable CRC
		- In Scripting > File Manager
		- Upload [umi/real\_world/cmd\_measure.lua](https://github.com/real-stanford/universal_manipulation_interface/blob/main/umi/real_world/cmd_measure.lua)
		- In Settings > System
...
4. Setup GoPro:
	- Install GoPro Labs [firmware](https://gopro.com/en/us/info/gopro-labs).
		...
		[![](https://github.com/real-stanford/universal_manipulation_interface/raw/main/assets/QR-MHDMI1mV0r27Tp60fWe0hS0sLcFg1dV.png)](https://github.com/real-stanford/universal_manipulation_interface/blob/main/assets/QR-MHDMI1mV0r27Tp60fWe0hS0sLcFg1dV.png)
...
[![](https://github.com/real-stanford/universal_manipulation_interface/raw/main/assets/umi_cup.gif)](https://github.com/real-stanford/universal_manipulation_interface/blob/main/assets/umi_cup.gif)
...
: The policy doesn't work well under direct sunlight, since the dataset was collected during a rainiy week at Stanford.
...
[![](https://github.com/real-stanford/universal_manipulation_interface/raw/main/assets/umi_cup_arx.gif)](https://github.com/real-stanford/universal_manipulation_interface/blob/main/assets/umi_cup_arx.gif)

## 🏷️ License

This repository is released under the MIT license. See [LICENSE](https://github.com/real-stanford/universal_manipulation_interface/blob/main/LICENSE) for additional details.

## 🙏 Acknowledgement

- Our GoPro SLAM pipeline is adapted from [Steffen Urban](https://github.com/urbste) 's [fork](https://github.com/urbste/ORB_SLAM3) of [OBR\_SLAM3](https://github.com/UZ-SLAMLab/ORB_SLAM3).
