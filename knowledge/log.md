...
- **automation | Bilibili 收藏夹候选均为重复，未生成新研究包**
  - **变更**: 新增 [[_syntheses/bilibili-ai-daily-run-2026-09-16|Bilibili AI Daily Run 2026-09-16]]，更新 [[index|Knowledge Index]]。
  - **结果**: 成功读取 20 个候选，全部已在 `raw/` 或 `knowledge/` 中存在；模型选中、处理成功与失败均为 0，未运行第二阶段、ASR、source card、`sources.csv` 或单视频深研。
  - **限制**: TOS 前缀 `asr-audio/2026/09/16` 为空，符合零视频选中的预期；无待人工处理的视频。

## [2026-09-14]

- **automation | Bilibili 收藏夹候选均为重复，未生成新研究包**
  - **变更**: 新增 [[_syntheses/bilibili-ai-daily-run-2026-09-14|Bilibili AI Daily Run 2026-09-14]]，更新 [[index|Knowledge Index]]。
  - **结果**: 成功读取 20 个候选，全部已在 `raw/` 或 `knowledge/` 中存在；模型选中、处理成功与失败均为 0，未运行第二阶段、ASR、source card、`sources.csv` 或单视频深研。
  - **限制**: TOS 前缀 `asr-audio/2026/09/14` 为空，符合零视频选中的预期；无待人工处理的视频。
...
- **automation | Bilibili 收藏夹候选均为重复，未生成新研究包**
  - **变更**: 新增 [[_syntheses/bilibili-ai-daily-run-2026-09-09|Bilibili AI Daily Run 2026-09-09]]，更新 [[index|Knowledge Index]]。
  - **结果**: 成功读取 20 个候选，全部已在 `raw/` 或 `knowledge/` 中存在；模型选中、处理成功与失败均为 0，未运行第二阶段、ASR、source card、`sources.csv` 或单视频深研。
  - **限制**: TOS 前缀 `asr-audio/2026/09/09` 为空，符合零视频选中的预期；无待人工处理的视频。
...
- **ingest | Bilibili AI/具身智能每日视频采集**
  - **变更**: 新增或更新 [[_syntheses/bilibili-ai-daily-run-2026-09-08|Bilibili AI Daily Run 2026-09-08]]；处理 1 个 Bilibili 视频 source packet。
  - **来源**: `raw/_inbox/transcripts/` 与 `knowledge/_sources/` 中的 Bilibili 视频转录产物。
  - **限制**: 脚本只完成候选筛选、去重、转录和 source card 交接；行业判断仍需 Codex 后续综合，并对关键事实做一级来源交叉验证。

- **synthesis | Microduck 商业逻辑完成证据限定的单视频深研**
...
- **ingest | Bilibili AI/具身智能每日视频采集**
  - **变更**: 新增或更新 [[_syntheses/bilibili-ai-daily-run-2026-09-17|Bilibili AI Daily Run 2026-09-17]]；处理 3 个 Bilibili 视频 source packet。
  - **来源**: `raw/_inbox/transcripts/` 与 `knowledge/_sources/` 中的 Bilibili 视频转录产物。
  - **限制**: 脚本只完成候选筛选、去重、转录和 source card 交接；行业判断仍需 Codex 后续综合，并对关键事实做一级来源交叉验证。

- **synthesis | 三条 2026-09-17 processed 视频完成独立深研**
