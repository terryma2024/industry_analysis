---
title: Bilibili AI Daily Run 2026-08-29
type: synthesis
...
# Bilibili AI Daily Run 2026-08-29
...
- Check enabled: True
- Prefix: `asr-audio/2026/08/29`
- Objects found: 0

## Model Relevance Review

- `BV1s43t6UEaW`（“70分钟完整版！质疑苏度，理解苏度，成为苏度”）：不选中。标题呈现的是对个人/观念的长谈，未显示 AI、机器人、模型、算力、数据或相关产业链研究主题；保留在未选候选池，不下载或转录。
- `BV1cvTq68E5g`（“985哲学系，大厂离职，旅居20个国家后的人生感悟”）：不选中。个人职业与旅行感悟不构成 AI/具身智能、机器人或相关工具链研究线索。

结论：模型选中数为 `0`；因此未运行第二阶段处理，也没有新增 transcript、ASR、source card、行业 `sources.csv` 或单视频深研页。
