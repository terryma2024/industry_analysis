---
title: Bilibili AI Daily Run 2026-08-17
type: synthesis
...
# Bilibili AI Daily Run 2026-08-17
...
| Video ID | Model judgment | Scope decision | Rationale |
|---|---|---|---|
| `BV1s43t6UEaW` | 不相关 | 未选中 | 标题显示为围绕“苏度”的个人/文化长访谈，未呈现 AI、具身智能、机器人、智能体、模型、算力或相关产业链主题。 |
| `BV1cvTq68E5g` | 不相关 | 未选中 | 个人职业与旅居感悟内容；标题没有指向 AI 或具身智能相关技术、产品、公司或产业链。 |

因此模型选中数为 0，未运行第二阶段；没有新 transcript、source card、`sources.csv` 条目或单视频深度调研页。
...
- 本日无模型选中且 `processed` 的视频，无需创建或更新 source packet、单视频深研或行业页。
