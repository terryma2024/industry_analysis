---
title: Bilibili AI Daily Run 2026-09-08
type: synthesis
...
# Bilibili AI Daily Run 2026-09-08
...
- Check enabled: True
- Prefix: `asr-audio/2026/09/08`
- Objects found: 2
- Recent keys:
  - `asr-audio/2026/09/08/010434-asr-audio.m4a`
  - `asr-audio/2026/09/08/010437-asr-audio.m4a`

## Candidate Decisions

| Status | Title | Video ID | Score | Reason |
|---|---|---:|---:|---|
| selected | Microduck商业逻辑分析 | `BV1qFtg6cEvN` | 0 | selected by model relevance judgment |
| skipped_duplicate | 机械做具身智能吃香吗？优先从机器人结构设计入手！AI机械臂从0到1分步讲解实操流程，菜鸟也能轻松上手开发！自然语言交互/强化学习/模仿学习/智能体 | `BV1Jpti63EyF` | 0 | video identifier already appears in raw/ or knowledge/ |
...
- `BV1qFtg6cEvN` Microduck商业逻辑分析: processed; transcript captured and source card written; raw=`raw/_inbox/transcripts/2026-09-08-bilibili-bv1qftg6cevn-microduck.json`; source=`knowledge/_sources/bilibili-bv1qftg6cevn-microduck.md`
