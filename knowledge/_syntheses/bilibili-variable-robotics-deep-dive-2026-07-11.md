...
> [!warning] 证据边界
> 视频为 B 级线索。官网 `SRC-robotics-271` 确认公司 2023 年 12 月成立、端到端具身模型定位、WALL-A/WALL-B、四地布局与部分投资方；估值、融资、客户、收入、任务成功率和硬件参数仍未获一级证实。
...
| 类型 | 内容 | 处理 |
|---|---|---|
| 事实 | 官网披露 WALL-A、WALL-B、端到端路线、量子系列与无本体数采入口。 | `SRC-robotics-271` |
