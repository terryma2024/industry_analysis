...
> [!info] 使用方式
> 这不是投资推荐清单，而是后续研究的公司池。优先用于识别产业链位置、利润池、国产替代环节、商业化可信度和你的职业切入点。公司状态变化快，未上市公司信息尤其需要后续用融资公告、客户案例、招聘和工商信息交叉验证。

> [!note] 产品型号对比
> 主表机器人公司的产品型号、参数、技术路线和优缺点已整理到 [[13-robot-company-product-comparison-2026-06-08|机器人公司产品型号全景对比]]；零部件公司仍保留在本页和投资视角中跟踪。
...
| 逐际动力 LimX Dynamics | 人形/多形态双足/具身 OS/VLA 工具链 | 整机+操作系统+开发工具 | 科研、开发者、集成商、制造/商业/家庭探索 | 运动控制、模块化本体和工具链定位清晰，FluxVLA 开源增强平台信号 | 收入、出货、客户复购和场景 ROI 待验证 | [[_entities/LimXDynamics\|LimX Dynamics]] [`SRC-robotics-103`](../../raw/robotics-embodied-ai/documents/SRC-robotics-103-limx-dynamics-about-page.md) [`SRC-robotics-108`](../../raw/robotics-embodied-ai/documents/SRC-robotics-108-fluxvla-engine-documentation.md) [`SRC-robotics-110`](../../raw/robotics-embodied-ai/documents/SRC-robotics-110-2-b.md) |
...
| 自变量机器人 X2Robot | 具身大模型+轮式双臂机器人 | 模型+本体+场景应用 | 工业操作、家庭/商业服务探索 | 强调端到端操作大模型 WALL-A | 模型能力和订单需第三方验证 | 官方网站 |
| 魔法原子 MagicLab | 人形/四足整机 | 整机+工业/商业/家庭场景 | 工业、商业、大健康 | 官网披露 MagicBot 参数和订单新闻 | 新公司，客户与交付需验证 | 官方网站 |
| 越疆 DOBOT | 协作机器人+具身智能多形态机器人 | 协作机械臂、人形、轮式、多足产品 | 工业、商业、科研教育 | 协作机器人出货基础强，具备制造场景 know-how | 人形机器人业务占比待验证 | 官方网站 |
| 节卡 JAKA | 协作机器人/具身智能机器人 | 协作机器人+移动作业机器人+数采训练系统 | 工业制造、物流、分拣、巡检 | 协作机器人基础，可向具身作业迁移 | 具身业务商业化早期 | 官方网站 |
| 遨博 AUBO | 协作机器人 | 协作机器人+行业解决方案 | 3C、汽车、医疗、新零售、物流 | 协作机器人标准和渠道基础 | 与通用具身智能距离较远 | 官方网站 |
| 新松机器人 SIASUN | 工业/移动/特种/半导体机器人 | 机器人产品+智能制造解决方案 | 汽车、新能源、半导体、物流等 | 上市公司，产品线和客户覆盖广 | 盈利能力、传统集成业务周期性 | 官方网站/公告 |
| 埃斯顿 ESTUN | 工业机器人/自动化 | 工业机器人+工作站+核心部件 | 光伏、锂电、汽车、电子制造 | 国产工业机器人龙头之一 | 人形/具身关联需区分于传统工控 | 官方网站 |
| 埃夫特 EFORT | 工业机器人/系统集成 | 工业机器人+跨行业智能制造方案 | 汽车、3C、光伏、锂电、金属加工 | 科创板上市，工业机器人第一梯队 | 集成业务毛利和周期风险 | 官方网站/年报 |
...
| 光轮智能 Lightwheel | 物理 AI 数据/仿真/评测基础设施 | SimReady、EgoSuite、RoboFinals、Real2Sim2Real | 真实人类数据、仿真合成数据、物理资产、模型评测与部署反馈闭环；订单规模较强但收入质量待验证 | [[_entities/LightwheelAI\|光轮智能]] [`SRC-robotics-379`](../../raw/robotics-embodied-ai/documents/SRC-robotics-379-lightwheel-nvidia-customer-story-and-geely-factory-deployment.md) [`SRC-robotics-381`](../../raw/robotics-embodied-ai/documents/SRC-robotics-381-beijing-government-report-on-lightwheel-financing-orders-and-delivery-scale.md) |
| 求之科技 | 具身数据工厂/闭环平台 | RSR、DISCOVERSE、Real2Sim、数采工厂方案 | 产品链覆盖真实/仿真采集、训练、评测和部署；客户、收入、回款与平台/项目制拆分待验证 | [`SRC-robotics-400`](../../raw/robotics-embodied-ai/documents/SRC-robotics-400-discover-robotics-rsr-embodied-data-closed-loop-platform.md) |
| 极佳视界 | 世界模型+具身模型+本体全栈 | GigaWorld、GigaBrain、Maker/拾光 | 技术链与光轮高度重叠，但通过模型授权、机器人和场景方案纵向一体化变现 | [`SRC-robotics-401`](../../raw/robotics-embodied-ai/documents/SRC-robotics-401-gigaai-company-and-full-stack-physical-agi-platform.md) [`SRC-robotics-402`](../../raw/robotics-embodied-ai/documents/SRC-robotics-402-gigaai-financing-and-industrial-deployment-report.md) |
| Applied Intuition / Parallel Domain / Duality AI | 海外 Physical AI 企业平台 | 数据闭环、Real2Sim、数字孪生、合成数据、验证 | 分别对应平台商业模式、资产飞轮和 SimReady/验证直接对标；详见 [[research-notes/lightwheel-peer-companies-business-model-comparison-2026-08-06\|同类公司调研]] | [`SRC-robotics-394`](../../raw/robotics-embodied-ai/documents/SRC-robotics-394-applied-intuition-end-to-end-physical-ai-platform.md)–[`SRC-robotics-396`](../../raw/robotics-embodied-ai/documents/SRC-robotics-396-parallel-domain-reconstruction-and-sensor-simulation-platform.md) |
...
- 进入壁垒：整机壁垒来自软硬件系统工程、运动控制、数据闭环、供应链和场景交付；零部件壁垒来自精密制造、良率、寿命、批量一致性、客户验证周期。
- 价格/成本趋势：整机价格会下降，真正受益的可能不是所有整机厂，而是能规模化供货、进入多个客户 BOM 的核心零部件和平台软件公司。
- 新进入者：AI 大模型公司、汽车公司、工控自动化公司、协作机器人公司、AMR 公司都在向具身智能延伸。
- 替代者：很多场景不一定需要人形机器人，AMR+机械臂、专机自动化、协作机器人、传统工业机器人可能更快产生 ROI。

## 需要跟踪的公司

- 上市公司：
  - 整机/工业机器人：优必选、新松机器人、埃斯顿、埃夫特、越疆科技。
  - 核心零部件：绿的谐波、双环传动、中大力德、步科股份、鸣志电器、禾川科技、汇川技术、奥比中光、柯力传感、东华测试。
  - 服务/消费机器人邻近公司：科沃斯、石头科技、九号公司、云迹科技、擎朗智能、高仙机器人（用于场景和渠道对比）。
- 未上市公司：
  - 人形/通用具身：宇树科技、智元机器人、逐际动力、星动纪元、银河通用、自变量机器人、魔法原子、乐聚机器人、松延动力、开普勒机器人、傅利叶智能、小鹏机器人。
  - 移动操作/工业具身：优艾智合、极智嘉、快仓、斯坦德机器人、仙工智能、海柔创新、镁伽科技、翼菲科技。
- 海外公司：
  - 整机/具身：Tesla Optimus、Figure AI、1X、Agility Robotics、Boston Dynamics、Apptronik、Sanctuary AI、NEURA Robotics。
  - 平台/基础设施：NVIDIA Isaac/GR00T、Google DeepMind、Meta、OpenAI（如有机器人方向公开进展）。
  - 零部件/自动化：Harmonic Drive、Nabtesco、Maxon、Faulhaber、Kollmorgen、Moog、Keyence、Cognex、Yaskawa、Fanuc、ABB、KUKA。
- 产业链关键供应商：
  - 减速器：绿的谐波、双环传动/环动科技、中大力德、秦川机床、丰立智能。
  - 电机/执行器：步科股份、鸣志电器、禾川科技、汇川技术、雷赛智能、拓普集团、三花智控。
  - 丝杠/轴承/精密传动：秦川机床、贝斯特、长盛轴承、五洲新春、北特科技、恒立液压。
  - 传感器/视觉：奥比中光、柯力传感、东华测试、汉威科技、韦尔股份、舜宇光学、速腾聚创、禾赛科技。
  - 控制/算力/软件：汇川技术、固高科技、NVIDIA、地平线、黑芝麻智能、华为昇腾/具身智能生态。

## 投资分析优先级

| 优先级 | 公司/环节 | 为什么先看 |
|---|---|---|
| 1 | 核心零部件：减速器、电机、执行器、力传感器、视觉 | 容易进入多个整机厂供应链，商业化比单一整机路线更可验证 |
| 1 | 有财报的整机公司：优必选、新松、埃斯顿、埃夫特、越疆 | 可以用收入、毛利、订单、现金流验证叙事 |
| 2 | 场景明确的 AMR/移动操作公司：极智嘉、快仓、优艾智合 | 真实场景和客户多，具身智能可能先在工业/仓储落地 |
| 2 | 新兴人形整机：宇树、智元、逐际、星动、银河、魔法原子 | 代表技术路线，但需要严防 demo/融资叙事过热 |
| 3 | 服务/消费机器人：科沃斯、石头、云迹、擎朗、高仙 | 可用于理解渠道、服务场景、售后和规模化运营 |

## 对职业转型的含义

- 你的软件和大团队管理经验，最匹配的是“机器人软件平台、数据闭环、仿真训练、云端运维、调度系统、行业解决方案产品化”，而不是直接补机械设计从零做起。
- 优先关注具备真实场景数据的公司：AMR/仓储、工业移动操作、协作机器人、工业整机公司，它们更需要工程化、平台化和交付管理能力。
- 人形创业公司适合关注平台/产品/工程管理岗位，但要重点验证是否已有真实客户、持续订单、稳定交付和数据闭环。
- 上游零部件公司职业切入更偏 B2B 产品、供应链、工业软件、测试平台、客户工程，不一定需要机器人算法背景，但需要理解工业客户验证逻辑。
