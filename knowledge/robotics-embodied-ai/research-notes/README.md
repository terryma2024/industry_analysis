...
- [[microduck-diy-replication-feasibility-2026-09-02]]: 按 R05 主分类、R08/R04 次分类，校正关节分配、开源边界、软件栈、50 Hz 实时性和双 IMU 推断；用官方零售价证明忠实复刻没有零售 BOM 优势，并给出仿真、总线、全关节与动态四级 PoC、商业应用和创业边界。
