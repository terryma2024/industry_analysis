...
更深一层原因是：进入行业后才有机会接触真实场景和相关人才，对行业的理解和经验积累会更快。因此“先进入行业”不是身份目标，而是为了建立更快的学习飞轮。

时间窗口约束：由于年龄已经较大，越往后找到相关从业机会越难；同时具身智能行业已经开始升温，进入行业的人会越来越多，竞争会加大。因此经验积累需要尽量快，不能选择学习曲线过长、短期难以入场的路径。

“较快入场”的第一判断标准：

> 优先选择把通用软件平台能力作为硬要求、把机器人领域知识作为可补齐能力的岗位。

对应的正向 JD 信号包括：平台系统、任务调度、数据闭环、仿真平台、运营系统、云端服务、工程效率、后端服务、分布式系统、微服务、Kubernetes、数据管道、平台架构等。反向信号包括：岗位第一屏就要求控制算法、运动规划、嵌入式实时系统、强化学习或大模型训练。
...
graph TD
  ...
  PA3 --> PA6["学习飞轮<br/>真实场景<br/>相关人才<br/>更快积累行业理解"]
  PA6 --> PA7["时间窗口约束<br/>年龄<br/>行业升温<br/>竞争加大"]
  PA7 --> PA8["较快入场标准<br/>通用软件平台能力是硬要求<br/>机器人知识是可补齐能力"]
