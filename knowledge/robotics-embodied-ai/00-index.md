...
- [[research-notes/microduck-diy-replication-feasibility-2026-09-02|Microduck DIY 复刻可行性与教学平台选型]]: R05 主分类、R08/R04 次分类；官方开源只覆盖软件，15 个 XL330 的美国官网零售价合计已高于整机预售价，忠实复刻应视为研发项目而非低成本替代。
- [[_syntheses/bilibili-microduck-commercial-model-deep-dive-2026-09-08|Microduck 开源机器人平台商业逻辑视频深度调研]]: 将低价入口、开放生态、数据飞轮和硬件销售假设拆分为可核验线索；销量、价格、公司关系、复购和数据资产均待一级来源验证。
...
- [[research-notes/lightwheel-peer-companies-business-model-comparison-2026-08-06|光轮智能同类创业公司与商业模式对比调研]]: R06 主分类、R03/R07 次分类；按真实数据、Real2Sim/资产、合成仿真、训练、评测和部署反馈统一比较 12 家候选并形成短名单。
